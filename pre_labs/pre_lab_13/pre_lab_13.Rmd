...
**Task** Run the following code. Describe the model output. What do you see? **Answer The correlation between the per_pupil_2021 variable and the gdp_growth_2021 variable has a p-balue of 0.67, meaning that it's not particularly reliable or statistically significant.**
