...
**Task** Run the following codeblock to calculate the percentage change and put the state with the largest percentage growth below. **Answer It looks like Utah had the most change, at 18.37%.**
...
**Task** Run the following codeblock to find the Maryland county with the highest median household income and put the answer below. **Answer The county with the highest median income seems to be Howard County, sitting at 2122.**
...
**Task** Run the following codeblock to create a chart showing the margin of error for each county. The current headline isn't very descriptive of the data. What should it be? **Answer** maybe something like "average median income in Maryland by county"
...
Is the difference between Calvert and Montgomery significant? **Answer No – with the margins of error, it's entirely possible that they even have the same median income.**

Is the difference between Howard and everyone else significant? **Answer Yes indeed. Even with margins of error accounted for, Howard is still much higher than every other county.**
...
**Add your answer here: Baltimore city (43%), Garrett County (42.09%), and Allegany County (41.3%).**
