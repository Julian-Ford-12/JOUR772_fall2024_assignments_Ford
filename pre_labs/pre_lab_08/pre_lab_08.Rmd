...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last version of the chart? **Answer The theme has changed significantly here, with the background color growing much lighter, in contrast against the dark bars.**
