...
pg_county_schools <- school_payments|>
  filter(
    str_detect(vendor_name, "PRINCE GEORGE COUNTY PUBLIC SCHOOLS") | 
    str_detect(vendor_name, "PRINCE GEORGE PUBLIC") | 
...
```{r}
  payments |>
    filter(
      str_detect(agency_name, "CAPITAL PROJECT") &
...
```{r}
stem_cell_loans <- md_grants_loans |>
